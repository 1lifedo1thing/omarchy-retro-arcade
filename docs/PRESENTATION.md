...
The eleventh source-build game uses original snowy terrain, skier, gates and
horned creature geometry inside the existing cabinet. It offers Practice,
...
[Next human playtest](../games/freeski/docs/NEXT.md).
