...
The complete square mark is preserved. It is displayed at 52 x 52 in the app header, 82 x 82 logical table units, and as the desktop icon. The 256px transparent raster and the actual native render were visually inspected. Geometry, original green colour, aspect ratio and transparent negative space are unchanged. The SVG source remains unmodified.
