...
created on 12–13 September 2026 under GPL-3.0-or-later.

| Source | Contents | Creation method |
| --- | --- | --- |
| `shelf.svg` | Snowfield, skier, trees and FreeSki nameplate | Hand-authored SVG geometry |
| `../src/render.rs` | Skier, trees, rocks, striped ramps, shadows, protection ring, boundary marks, finish flags, Slalom gates, horned snow runner and tracks | Original native egui vector drawing |
