...
with tempfile.TemporaryDirectory(prefix='arcade-mouse-') as tmp:
    ...
    try:
        ...
        bottom = h - 32 - 46
        top = 144
        games = ['Circuit Pinball','Solitaire','Scram','Invaders','Chess','Stack','Snake','Bubble','Blast','2048','Shatter','Tanks','Minesweeper','FreeSki']
        def select(index):
        ...
        shot('shelf')
        # All fourteen entries can be selected, launched and left without a key.
        ...
        print('PASS: fourteen mouse launches/returns, Pinball confirm/cancel, Invaders mouse and keyboard handoff')
